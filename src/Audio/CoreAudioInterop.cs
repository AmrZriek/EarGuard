...
namespace EarGuard.Audio
{
    ...
    public interface IMMDeviceEnumerator
    {
        ...
        [PreserveSig] int GetDevice([MarshalAs(UnmanagedType.LPWStr)] string pwstrId, out IMMDevice endpoint);
    ...
    public static class CoreAudioConstants
    {
        ...
        public static readonly PROPERTYKEY PKEY_DeviceDesc = new PROPERTYKEY
        {
            fmtid = new Guid("b3f8fa53-0004-438e-9003-51a46e139bfc"),
            pid = 6
        };

        public static readonly PROPERTYKEY PKEY_Interface_FriendlyName = new PROPERTYKEY
        {
